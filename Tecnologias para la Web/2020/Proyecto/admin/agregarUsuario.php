                    ...
                    <form id="agregarUsuario" autocomplete="off">  
                            <div class="rounded-md bg-gray-100 px-3 py-2 text-base text-center md:container md:mx-auto">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div class="col-span-2 ...">
                                        <input type="text" id="telefono" name="telefono" class="rounded-md px-3 py-2">
                                    </div>
                                    <div class="...">
                                        <div>Nombre</div>
                                    </div>
                                    ...
                                    <div class="col-span-2 ...">
                                        <select id="rango" name="rango" class="rounded-md px-3 py-2 shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
