...
<html>
    ...
    <body class="bg-slate-600">
        ...
        <div class="container my-5 mx-auto lg:mx-10 flex-auto text-center ">
            ...
            <div class="lg:grid lg:grid-cols-4 lg:gap-3 mx-2">
                <div class="lg:col-start-2 lg:col-span-2 mx-6">
                    <form id="platillo" autocomplete="off">  
                            <div class="rounded-md bg-gray-100 px-3 py-2 text-base text-center md:container md:mx-auto">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <div class="col-span-2 ...">
                                        <input type="text" id="platillo" name="platillo" class="rounded-md px-3 py-2">
                                    </div>
                                    <div class="... text-center">
                                        <div>Tipo de Platillo</div>
                                    </div>
                                    <div class="col-span-2 ...">
                                        <input type="text" id="tipo" name="tipo" class="rounded-md px-3 py-2">
                                    </div>
                                    <div class="...">
                                        <div>Ingredientes</div>
                                    </div>
                                    <div class="col-span-2 ...">
                                        <input type="text" id="ingredientes" name="ingredientes" class="rounded-md px-3 py-2">
                                    </div>
                                    <div class="...">
                                        <div>Notas del Platillo</div>
                                    </div>
                                    <div class="col-span-2 ...">
                                        <input type="text" id="notas" name="notas" class="rounded-md px-3 py-2">
                                    </div>
                                    <div class="...">
                                        <div>Precio</div>
                                    </div>
                                    <div class="col-span-2 ...">
                                        <input type="number" id="precio" name="precio" class="rounded-md px-3 py-2">
                                    </div>
        ...
        <script src="./js/agregarPlatillo.js"></script>
    </body>
</html>
